...
export default function OutletBe() {
  ...
  return (
    <Box sx={{ display: 'flex', bgcolor : "#141B2D" }}>
      <CssBaseline />
          ...
          },
          {
            ...
            <ListItem  key={text.text} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText  primary={text.text} sx={{ opacity: open ? 1 : 0, color : "white" , ":hover" : {
                        color : "#525FE1"
                } }} />
              </ListItemButton>
                </Link>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, height : "959px" }}>
        <DrawerHeader />
        <Outlet />
      </Box>
    </Box>
